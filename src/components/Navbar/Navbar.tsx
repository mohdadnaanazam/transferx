			...
			<div className="container mx-auto flex items-center justify-between">
				<div className="flex items-center space-x-4">
					...
					<div className="hidden md:flex space-x-4">
						...
						<Link href="#" className="text-gray-300 hover:text-white">Assets</Link>
						<Link href="#" className="text-gray-300 hover:text-white">Folders</Link>
						<Link href="#" className="text-gray-300 hover:text-white">Collections</Link>
						<Link href="#" className="text-gray-300 hover:text-white">Moderation</Link>
					</div>
				</div>
				<div className="hidden md:flex items-center space-x-4">
					<div className='flex justify-start items-center dark:bg-[#020817] border-[1px] rounded-md px-2'>
						<input type="text" placeholder="Search Media" className="p-2 text-white outline-none dark:bg-[#020817]" />
						<button><Search /></button>
					</div>
					<button className="bg-green-0 text-white px-4 py-2 rounded">
						Upload
					</button>
				</div>
